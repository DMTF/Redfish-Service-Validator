...
class TestCatalog(unittest.TestCase):
    ...
    def test_expected_uris(self):
        ...
        object = catalog.RedfishObject(my_type).populate(
            {"@odata.id": "/redfish/v1/Example", "Id": "Example", "Description": None}
        )
        self.assertTrue(object.HasValidUri)

        object = catalog.RedfishObject(my_type).populate(
            {"@odata.id": "/redfish/v1/Examples", "Id": "Examples", "Description": None}
        )
        self.assertFalse(object.HasValidUri)

        object = catalog.RedfishObject(my_type).populate(
            {"@odata.id": "/redfish/v1/Examples/FunnyId", "Id": "FunnyId", "Description": None}
        )
        self.assertTrue(object.HasValidUri)
        self.assertTrue(object.HasValidUriStrict)

        object = catalog.RedfishObject(my_type).populate(
            {"@odata.id": "/redfish/v1/Examples/SubObject/FunnyId", "Id": "FunnyId", "Description": None}
        )
        self.assertTrue(object.HasValidUri)
        self.assertTrue(object.HasValidUriStrict)

        object = catalog.RedfishObject(my_type).populate(
            {"@odata.id": "/redfish/v1/Examples/SubObject/FunnyId", "Description": None}
        )
        self.assertTrue(object.HasValidUri)
        self.assertTrue(object.HasValidUriStrict)

        object = catalog.RedfishObject(my_type).populate(
            {"@odata.id": "/redfish/v1/Examples/WrongId", "Id": "FunnyId", "Description": None}
        )
        self.assertTrue(object.HasValidUri)
        self.assertFalse(object.HasValidUriStrict)

        object = catalog.RedfishObject(my_type).populate(
            {"@odata.id": "/redfish/v1/Examples/NoId", "Id": None, "Description": None}
        )
        self.assertTrue(object.HasValidUri)
        self.assertTrue(object.HasValidUriStrict)

    ...
    <div class="resource-header">
      ...
      <div class="btn-group">
        <span class="btn btn-results"
          onclick="(function(btn){{var r=document.getElementById('{rid}'),p=document.getElementById('{pid}'),b=btn.parentNode.querySelector('.btn-both');if(btn.getAttribute('data-state')==='on'){{r.classList.remove('resultsShow');btn.setAttribute('data-state','');btn.innerHTML='&#9776; Results';}}else{{p.classList.remove('resultsShow');r.classList.add('resultsShow');btn.setAttribute('data-state','on');btn.innerHTML='&#9650; Hide';if(b){{b.setAttribute('data-state','');b.innerHTML='&#9783; Both';}}}}}})(this)">
          &#9776; Results
        </span>
        <span class="btn btn-payload"
          onclick="(function(btn){{var r=document.getElementById('{rid}'),p=document.getElementById('{pid}'),b=btn.parentNode.querySelector('.btn-both');if(btn.getAttribute('data-state')==='on'){{p.classList.remove('resultsShow');btn.setAttribute('data-state','');btn.innerHTML='&#123;&#125; Payload';}}else{{r.classList.remove('resultsShow');p.classList.add('resultsShow');btn.setAttribute('data-state','on');btn.innerHTML='&#9650; Hide';if(b){{b.setAttribute('data-state','');b.innerHTML='&#9783; Both';}}}}}})(this)">
          &#123;&#125; Payload
        </span>
        <span class="btn btn-both"
          onclick="(function(btn){{var r=document.getElementById('{rid}'),p=document.getElementById('{pid}'),br=btn.parentNode.querySelector('.btn-results'),bp=btn.parentNode.querySelector('.btn-payload');if(btn.getAttribute('data-state')==='both'){{r.classList.remove('resultsShow');p.classList.remove('resultsShow');btn.setAttribute('data-state','');btn.innerHTML='&#9783; Both';}}else{{r.classList.add('resultsShow');p.classList.add('resultsShow');btn.setAttribute('data-state','both');btn.innerHTML='&#9650; Hide';if(br){{br.setAttribute('data-state','');br.innerHTML='&#9776; Results';}}if(bp){{bp.setAttribute('data-state','');bp.innerHTML='&#123;&#125; Payload';}}}}}})(this)">
          &#9783; Both
        </span>
      </div>
    </div>
